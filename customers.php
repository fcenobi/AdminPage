...
// Start building query acording to input parameters
// If search string
if ($search_str) {
	$db->where('type', '%' . $search_str . '%', 'like');
...
?>>Desc</option>
            ...
            <button onclick="document.location='downloadpdf.php'; alert('Report Generated');" ><a href="filename.pdf" class="fa fa-file-pdf-o" style="font-size:16px">Download</a></button>
        </form>
    </div>
    <hr>
    <!-- //Filters -->
    ...
    <table class="table table-striped table-bordered table-condensed">
        <thead>
            <tr>
                ...
                <th width="15%">Type</th>
                <th width="15%">Name</th>
                <th width="15%">Cost/direct/Price</th>
                <th width="15%">OptionHours</th>
                <th width="10%">Weight</th>
                <th width="10%">Shopping Content Site</th>
                <th width=10%>Tech Talk</th>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td><?php echo htmlspecialchars($row['hrs']);?></td>
                <td><?php echo htmlspecialchars($row['weight']);?></td>
                <td><?php echo htmlspecialchars($row['content']);?></td>
                <td><?php echo htmlspecialchars($row['techtalk']);?></td>
                <td>
